...
velocity_measurement_mode = true;
plot_extended_diagnostics = false;
...
gap_junction_coupling_fraction_range = [1,0.5,0.1];
...
for igc = 1:length(gap_junction_coupling_fraction_range)
    ...
    for iw = 1:length(w)
        ...
        for it = 1:Nt
            ...
            wavefront_cells = find((ckt_V_old(1:2:end-1)<V_wavefront_threshold) ...
                & (ckt.V(1:2:end-1)>=V_wavefront_threshold));
            ...
            for i_cell = wavefront_cells' % Note: i_cell = cell_no+1.
                ...
                if (velocity_measurement_mode)
                    ...
                    if (i_cell==cell_B)
                        ...
                        fprintf('Calc. velocity = %4.2f cm/s for coupling fraction %4.2f and w = %i nm.\n',...
            ...
            waveback_cells = find((ckt_V_old(1:2:end-1)>=V_waveback_threshold)...
                & (ckt.V(1:2:end-1)<V_waveback_threshold));
